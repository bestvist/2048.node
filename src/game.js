...
class Game extends EventEmitter{
    ...
    start() {
        this.grid = new Grid(this.interface);
        this.generateRandom();
        this.generateRandom();
        this.action();
    }
    ...
    drawLogo() {
        ...
        this.interface.output.write(chalk.cyan(f2048));
    }
    ...
    drawTip() {
        const tip = `W or ↑ => Up\nA or ← => Left\nS or ↓ => Down\nD or → => Right\nPlease enter key.\n`;
        this.interface.output.write(tip);
    }
    ...
    won() {
        ...
        this.interface.output.write(chalk.yellow(str));
        this.stop();
    }

    lose() {
        const str = `GAME OVER!\n`;
        this.interface.output.write(chalk.green(str));
        this.stop();
    }
